//
//  RESOperationQueueSerialViewController.m
//  LongRunningTasks
//
...
#import "RESOperationQueueSerialViewController.h"

@interface RESOperationQueueSerialViewController ()
-(void)performLongRunningTaskForIteration:(id)iteration;
-(void)updateTableData:(id)moreData;
@end

@implementation RESOperationQueueSerialViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    static NSString *CellIdentifier =@"RESOperationQueueSerialCell";
