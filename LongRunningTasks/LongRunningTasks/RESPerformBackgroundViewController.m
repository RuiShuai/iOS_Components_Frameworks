//
//  RESPerformBackgroundViewController.m
//  LongRunningTasks
//
...
#import "RESPerformBackgroundViewController.h"

@interface RESPerformBackgroundViewController ()
-(void)performLongRunningTaskForIteration:(id)iteration;
-(void)updateTableData:(id)moreData;
@end

@implementation RESPerformBackgroundViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    static NSString *CellIdentifier =@"RESPerformBackgroundCell";
