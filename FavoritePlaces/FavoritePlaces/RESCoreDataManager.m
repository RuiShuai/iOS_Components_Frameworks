...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator {
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:MODEL_STORE_NAME];
    ...
    if (!dataFileAlreadyExists) {
        NSString *bundleStore = [[NSBundle mainBundle] pathForResource:MODEL_NAME ofType:@"sqlite"];
        NSLog(@"%@",bundleStore);
...
- (NSURL *)applicationDocumentsDirectory {
    // The directory the application uses to store the Core Data store file. This code uses a directory named "com.ruishuai.FavoritePlaces" in the application's documents directory.
