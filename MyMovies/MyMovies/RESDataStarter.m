...
@implementation RESDataStarter

+ (void)setupStarterData
{
    //RESAppDelegate *myAppDelegate = [[UIApplication sharedApplication] delegate];
    ...
    NSManagedObject *newMovie1 = [NSEntityDescription insertNewObjectForEntityForName:@"Movie" inManagedObjectContext:moc];
    
    [newMovie1 setValue:@"The Matrix" forKey:@"title"];
    [newMovie1 setValue:@"1999" forKey:@"year"];
    [newMovie1 setValue:@"Why oh why didn't I take the Blue pill" forKey:@"movieDescription"];
    ...
    //Friends * 7
    NSManagedObject *newFriend1 = [NSEntityDescription insertNewObjectForEntityForName:@"Friend" inManagedObjectContext:moc];
